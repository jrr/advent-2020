...
[<Fact>]
let ``solves 4a example`` () = solve input |> should equal 2
...
[<Fact>]
let ``solves 4a problem`` () = solve input2 |> should equal 190

[<Fact>]
let ``validate fields`` () =
    validateFieldValue ("byr", "1950") |> should equal true
    validateFieldValue ("byr", "1900") |> should equal false
    
    validateFieldValue ("iyr", "2015") |> should equal true
    validateFieldValue ("iyr", "1800") |> should equal false
    
    validateFieldValue ("eyr", "2025") |> should equal true
    validateFieldValue ("eyr", "3000") |> should equal false
    
    validateFieldValue ("hgt", "5cm") |> should equal false
    validateFieldValue ("hgt", "175cm") |> should equal true
    
    validateFieldValue ("hcl", "#abc123") |> should equal true
    validateFieldValue ("hcl", "#azc123") |> should equal false
    validateFieldValue ("hcl", "foobar") |> should equal false
    
    validateFieldValue ("ecl", "ZZ") |> should equal false
    validateFieldValue ("ecl", "gry") |> should equal true
    
    validateFieldValue ("pid", "123") |> should equal false
    validateFieldValue ("pid", "123456789") |> should equal true

[<Fact>]
let ``validate example fields`` () =
    validateFieldValue ("byr","2002") |> should equal true
    validateFieldValue ("byr","2003") |> should equal false
    validateFieldValue ("hgt","60in") |> should equal true
    validateFieldValue ("hgt","190cm") |> should equal true
    validateFieldValue ("hgt","190in") |> should equal false
    validateFieldValue ("hgt","190") |> should equal false

    validateFieldValue ("hcl","#123abc") |> should equal true
    validateFieldValue ("hcl","#123abz") |> should equal false
    validateFieldValue ("hcl","123abc") |> should equal false

    validateFieldValue ("ecl", "brn") |> should equal true
    validateFieldValue ("ecl","wat") |> should equal false

    validateFieldValue ("pid","000000001") |> should equal true
    validateFieldValue ("pid","0123456789") |> should equal false

[<Fact>]

let ``solves 4b example 1`` () =
    let example1 = """
    eyr:1972 cid:100
...
"""
    solve2 example1 |> should equal 0
    
[<Fact>]
let ``solves 4b example 2`` () =
    let example2 = """
...
"""
    solve2 example2 |> should equal 4
    
[<Fact>]
let ``solves 4b `` () = solve2 input2 |> should equal 121
